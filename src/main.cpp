...
unsigned int nStakeTargetSpacing = 2 * 60; // DIFF: 2-minute block spacing
...
const string strMessageMagic = "Tengri Signed Message:\n";
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Tengri", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1945-08-15-2017-06-13";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x27c09998544ae186d6692dceac26b25c3411b1d560aef043b290fef965074cd4"));
